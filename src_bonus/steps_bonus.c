...
/*   Updated: 2023/02/23 12:42:21 by cyacoub-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	t_win_steps(t_game *game)
{
	if (game->player.steps_flg)
		t_steps(game);
	mlx_put_image_to_window(game->mlx, game->win, game->map.cell, 0, 0);
	mlx_put_image_to_window(game->mlx, game->win, game->map.wall, 0, 0);
	mlx_put_image_to_window(game->mlx, game->win, game->map.cell, 0, 32);
