...
/*   Updated: 2023/02/16 11:24:24 by cyacoub-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->map.cell[0] = mlx_xpm_file_to_image(game->mlx,
			"./xpm/grass1.xpm", &game->img_width, &game->img_height);
	game->map.cell[1] = mlx_xpm_file_to_image(game->mlx,
			"./xpm/grass2.xpm", &game->img_width, &game->img_height);
	game->map.cell[2] = mlx_xpm_file_to_image(game->mlx,
			"./xpm/grass3.xpm", &game->img_width, &game->img_height);
